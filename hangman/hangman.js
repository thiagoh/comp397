...
function drawPlatform() {
  ...
  //   platform.graphics.beginFill("#000");
  platform.graphics.beginStroke("#000");

  platform.graphics.setStrokeStyle(2);

  platform.graphics.moveTo(0, 0);
  platform.graphics.lineTo(platformWidth, 0);

  platform.graphics.moveTo(platformWidth * 0.75, 0);
  platform.graphics.lineTo(platformWidth * 0.75, -100);
  platform.graphics.lineTo(platformWidth * 0.25, -100);
...
function drawRope() {
  ...
  platform.graphics.lineTo(platformWidth * 0.25, -80);
}

function drawHead() {

  platform.graphics.beginFill("#cccccc");
  platform.graphics.drawCircle(platformWidth * 0.25, -70, 10);
}

function drawTorno() {

  platform.graphics.moveTo(platformWidth * 0.25, -60);
  platform.graphics.lineTo(platformWidth * 0.25, -30);
}

function drawHands() {

  platform.graphics.moveTo(platformWidth * 0.15, -50);
  platform.graphics.lineTo(platformWidth * 0.35, -50);
}

function drawFeet() {

  //left leg
  platform.graphics.moveTo(platformWidth * 0.25, -30);
  platform.graphics.lineTo(platformWidth * 0.15, -10);

  //right leg
  platform.graphics.moveTo(platformWidth * 0.25, -30);
  platform.graphics.lineTo(platformWidth * 0.35, -10);
